...
def includeme(config):
    ...
    config.add_route('studies.external_services',           '/{study}/external-services',           factory=models.StudyFactory, traverse='/{study}/external-services')
    config.add_route('studies.external_service',            '/{study}/external-services/{service}', factory=models.StudyFactory, traverse='/{study}/external-services/{service}')
    ...
    config.add_route('studies.study_external_services',     '/{study}/manage-external-services',    factory=models.StudyFactory, traverse='/{study}')
